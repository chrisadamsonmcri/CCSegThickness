function [ReturnCode] = cc_seg_one_subject_pipe_seg(FileNameOrStruct, GroundTruthFile, OutputDir, OutputPrefix, MidSagMethod)
...
if(ischar(FileNameOrStruct))
	...
	elseif(ndims(AVW) == 3)
		...
		if(exist(OutputMAT, 'file') == 2 && strcmpi(MidSagMethod, 'acpvcdetect'))
